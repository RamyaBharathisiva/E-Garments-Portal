        ...
        <div class="container-fluid">
                ...
                <div class="navbar-right">
                    <img src="assets/profile.png" alt="img" height="50px"style="margin-right:20px" data-toggle="dropdown">
                        <ul class="dropdown-menu">
                            <li><a href="wprofile.py?id=%s" data-toggle="modal" data-target="#modal"><b><i class="fas fa-edit"></i> Edit Profile</b></a></li>
        ...
        <div class="container">
            <div class="row" id="banner">
                ...
                <div class="col-md-5" id="banner2">
                    ...
                    <button class="btn-default" id="shopbutton"><a href="wwomen.py?id=%s" style="text-decoration: none;color: black;">Shop Collection<span class="glyphicon glyphicon-triangle-right"></span></a></button>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="c-2">
                    ...
                    <div class="c-2-image-holder"> <img class="left" src="https://res.cloudinary.com/de8cuyd0n/image/upload/v1520412552/E-commerce%20landing%20page/suit-collections/collection-2-img_3x.jpg" alt=""><img class="right" src="https://res.cloudinary.com/de8cuyd0n/image/upload/v1520412552/E-commerce%20landing%20page/suit-collections/collection-1-img_3x.jpg"
                        alt=""></div>
                    <p class="button"><a href="wmen.py?id=%s" style="text-decoration: none;">view all collections</a></p>
                </div> <div class="c-1">
                ...
                <div class="blog-content">
                    <div class="blog-1">
                        ...
                        <div class="blog-1-content">
                            ...
                            <p class="button"><a href="wkids.py?id=%s" id="a2"><b>Shop Collections</b></a></p>
                        </div>
                    </div>
                    <div class="blog-2">
