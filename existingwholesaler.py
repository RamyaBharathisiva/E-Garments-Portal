...
q = """Select * from wholesaler where status = "Approved" """
cur.execute(q)
rec = cur.fetchall()
...
<body>
    <div class="wrapper">
        ...
        <div class="tabular-wrapper">
            <h3 class="min-title" style="font-size: 20px;"><b>Existing Wholesaler Details</b></h3>
...
for i in rec:
    ...
    print("""
                            <tr>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <td><input type="text" value="%s" name="ownername" style="width:80px;" readonly></td>
                                        ...
                                        <td><input type="text" value="%s" name="shopname" style="width:80px;"></td>
                                        <td><img src="%s" height="20px" width="20px"></td>
                                        <td><img src="%s" height="20px" width="20px"></td>
                                        <td><img src="%s" height="20px" width="20px"></td>
                ...
                """%(i[0],i[1],i[2],i[3],i[4],i[5],fn1,i[7],fn3,fn4,fn5,i[11],i[12],i[13],i[14],i[15],i[16],i[19]))
    ...
    if edit != None:
        if len(form) != 0:
            x= """update wholesaler set phno="%s",shopname="%s",door="%s",street="%s",city="%s",district="%s",state="%s",pincode="%s" where id="%s" """%(phno,shopname,door,street,city,district,state,pincode,id)
            cur.execute(x)
            con.commit()
            print("""
                        <script>
        ...
        if delete != None:
            q = """Delete from wholesaler where id = "%s" """%(id)
            cur.execute(q)
            con.commit()
            print("""
                <script>
