...
q = """Select * from product where useroffer>0 and  wholesaleroffer>0"""
cur.execute(q)
rec = cur.fetchall()
    ...
    <div class="wrapper">
        ...
        <div class="main--content" style="margin-left: 100px;">
            <div class="tabular-wrapper">
                <h3 class="min-title" style="font-size: 20px;"><b>Existing Offer Details</b></h3>
                <div class="table-container">
                    <table class="table">
                        <tr>
                            ...
                            <th>User Offer Price</th>
                            <th>Wholesaler Offer Price</th>
                            <th>Delete</th>
                        </tr>
                            ...
                            <td>
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="btn-grp">
                                            ...
                                            <button class="btn btn-danger" name="delete">Remove Offer</button>
                                        </div>
                                    </form>
                            </td>
                        </tr>          
            """%(i[1],i[2],i[8],i[9],i[10],i[11],i[1]))
...
if delete != None:
        q = """ UPDATE product SET useroffer = 0,wholesaleroffer=0 where productid = "%s" """ % (id)
        cur.execute(q)
        con.commit()
        print("""
                <script>
