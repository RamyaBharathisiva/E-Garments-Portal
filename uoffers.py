...
cur = con.cursor()
q = """Select * from product where useroffer>0 """
cur.execute(q)
rec1 = cur.fetchall()
...
print("""
        <div class="container-fluid">
            <p style="font-size: 40px;color:rgb(114, 4, 63);"><b>Womens Section</b></p>
            <hr>
            <br>
            <br>
            <div class="row">""")
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="margin-top:25px;padding-left: 60px;">
                                        ...
                                        <form action="" name="order" id="login">
                                            ...
                                            <div class="form-group">
                                                    <input type="number" id="totalprice" name="totalprice" value="%s"  class="form-control" readonly>
                                            </div>
                                            <div class="form-group">
...
""" % (i[1],fn, i[2], i[4], i[8],i[10],i[10],i[2],i[1],i[7]))
print("""
