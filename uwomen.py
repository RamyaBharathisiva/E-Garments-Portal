...
cur = con.cursor()
q = """Select* from product where category = "women" """
cur.execute(q)
rec1 = cur.fetchall()
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="uwomen.py?id=%s" style="margin-top: 30px;"><b>Women</b></a>
  <a href="umen.py?id=%s" style="margin-top: 30px;"><b>Men</b></a>
  <a href="ukids.py?id=%s" style="margin-top: 30px;"><b>Kids</b></a>
  <a href="udesign.py?id=%s" style="margin-top: 30px;color:rgb(231, 183, 120);"><b>Design</b></a>
  <a href="uoffers.py?id=%s" style="margin-top: 30px;color:rgb(231, 183, 120);"><b>Offers</b></a>
        ...
        <nav class="navbar navbar" style="font-size: 10px;box-shadow: 0px 5px 20px -10px rgb(0, 0, 0);">
            <div class="container-fluid">
                    ...
                    <div class="navbar-right">
                        <img src="assets/profile.png" alt="img" id="profile" data-toggle="dropdown">
                            <ul class="dropdown-menu">
                                <li><a href="uprofile.py" data-toggle="modal" data-target="#modal"><b><i class="fas fa-edit"></i> Edit Profile</b></a></li>
                                <li><a href="uorders.py"><b><i class="fa-solid fa-cart-shopping"></i> Orders</b></a></li>
                                <li><a href="home.py"><b><i class="fa fa-sign-out" style="font-size:24px"></i> Logout </b></a></li>
...
""" % (i[0],fn,i[2],i[4],i[0],i[0],i[0],i[8],i[0],i[2],i[1],i[7],i[0],i[0],i[0],i[0]))
print("""</div>
...
if order != None:
    if len(form) != 0:
        q="""insert into orders(productid,productname,category,quantity,size,price,card,cardno,expirydate)VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s')"""%(proname,proid,category,quan,size,prize,card,cardno,exdate)
        cur.execute(q)
        con.commit()
        print("""
                    <script>
