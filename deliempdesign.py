...
q = """SELECT userdesign.id,user.username,user.door,user.street,user.city,user.district,user.state,user.pincode,user.phno,userdesign.dresstype,userdesign.quantity,userdesign.size,userdesign.price,userdesign.totalprice,userdesign.card,userdesign.cardno,userdesign.expirydate,userdesign.status,userdesign.ordertime,userdesign.action FROM userdesign INNER JOIN user ON userdesign.userid = user.id where userdesign.status ="Approved" and userdesign.action!='Product Delivered' and userdesign.price != "Null" and userdesign.totalprice != "Null" and cardno != "Null" """
cur.execute(q)
rec = cur.fetchall()
    ...
    <div class="wrapper">
        ...
        <div class="container" style="margin-top: -20px;">
            ...
            <ol>
                        ...
                        <li><a href="deliempdesign.py">User Design Orders</a></li>
                        <li><a href="deliempdesignwhole.py">wholesaler Design Orders</a></li>
...
for i in rec:
    ...
    """ % (i[0], i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[13],i[14],i[15],i[16],i[17] , i[0]))
print("""
    </div>
</body>
</html>""")
...
if orderid != None:
    if confirm != None:
        q = """Update userdesign set action = "%s" where id="%s" """ % (confirm, orderid)
        cur.execute(q)
        con.commit()
        print("""
                <script>
