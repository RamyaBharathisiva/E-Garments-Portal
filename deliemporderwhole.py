...
for i in rec:
    ...
    """ % (i[0], i[1],i[10], i[19], i[11], i[12], i[13], i[14], i[15], i[16], i[17], i[0], i[9], i[3], i[4], i[5], i[6], i[7],
           i[8], i[20], i[0]))
print("""
    </div>
</body>
...
if orderid != None:
    if confirm != None:
        q = """Update wholeorders set action = "%s" where id="%s" """ % (confirm, orderid)
        cur.execute(q)
        con.commit()
        print("""
                <script>
