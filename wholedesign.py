...
<body>
    <div class="wrapper">
        ...
        <div class="tabular-wrapper" >
            <h3 class="min-title" style="font-size: 29px;margin-left:100px;"><b>Wholesaler New Designs</b></h3>
...
for i in rec:
    ...
    if i[12] != 'Approved' and i[12] != 'Discard':
        print("""
              ...
              """ % (
            i[0], i[1], i[2], i[3], i[4], i[5], i[6], i[7], i[8], fn1, i[10], i[11], i[0]))
...
if approve != None:
    q3 = """Update wholedesign set status="%s" where id="%s" """ % (approve, id)
    cur.execute(q3)
    con.commit()
    print("""
                <script>
                    alert("Approved Successfully!! You Can add price in Existing userdesign");
                </script>
        """)

if discard != None:
    q = """Update wholedesign set status = "%s" where id="%s" """ % (discard, id)
    cur.execute(q)
    con.commit()
    print("""
        <script>
