...
<div class="main--content" style="margin-left: 100px;">
        <div class="tabular-wrapper">
            <h3 class="min-title" style="font-size: 30px;"><b>New User Details</b></h3>
...
for i in rec:
    if i[14] != 'Approved' and i[14] != 'Discard':
        ...
        print("""<tr>
                        ...
                        """%(i[0],i[1],i[2],i[3],i[4],i[5],i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[3],i[1],i[0],i[5]))
...
if approve != None:
    ...
    server.quit()
    q = """ UPDATE user SET status= "%s" WHERE email = "%s" """ %(approve,emailid)
    cur.execute(q)
    con.commit()
    print("""
                <script>
...
if discard != None:
    q = """Update user set status = "%s" where id="%s" """ % (discard, id)
    cur.execute(q)
    con.commit()
    print("""
            <script>
