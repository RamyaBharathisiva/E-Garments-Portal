...
for i in rec:
    ...
    print("""   <div id="myModal-%s" class="modal fade" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <form action="" method="post" enctype="multipart/form-data" name="order" id="login">
...
""" % (i[0], fn, i[2], i[4], i[0], i[0], i[0], i[8], i[0], i[2], i[1], i[7],ID, i[3],i[0], i[0], i[0], i[0]))
print("""
